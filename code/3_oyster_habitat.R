...
copano_bay_survey <- sf::st_read(dsn = texas_oyster_dir, layer = "Copano_Habitats_WGSUTM14N") %>%
  clean_oyster()
...
### ***Note: None of these data fall within the present study area
espiritu_santo_survey <- sf::st_read(dsn = texas_oyster_dir, layer = "EspirituSanto_OysterShellHabitat_2017") %>%
  clean_oyster()
...
galveston_bay_survey <- sf::st_read(dsn = texas_oyster_dir, layer = "2019Delineation") %>%
  clean_oyster()
...
### ***Note: None of these data fall within the present study area
lavaca_tres_palacios_survey <- sf::st_read(dsn = texas_oyster_dir, layer = "OysterHabitat_LavacaTP_Merge") %>%
  clean_oyster()
...
west_galveston_bay_survey <- sf::st_read(dsn = texas_oyster_dir, layer = "WestGalvestonBay_OysterHabitatMap_TPWD2016") %>%
  clean_oyster()
...
oyster_restoration_sites <- sf::st_read(dsn = texas_oyster_dir, layer = "TPWD_Oyster_Restoration_Sites") %>%
  clean_oyster()
...
gom_atlas <- sf::st_read(dsn = gom_oyster_dir, layer = "Oysters_GOM_2011") %>%
  clean_oyster()
...
sf::st_write(copano_bay_survey, dsn = oyster_gpkg, layer = "copano_bay_survey", append = F)
sf::st_write(espiritu_santo_survey, dsn = oyster_gpkg, layer = "espiritu_santo_survey", append = F)
sf::st_write(galveston_bay_survey, dsn = oyster_gpkg, layer = "galveston_bay_survey", append = F)
sf::st_write(lavaca_tres_palacios_survey, dsn = oyster_gpkg, layer = "lavaca_tres_palacios_survey", append = F)
sf::st_write(west_galveston_bay_survey, dsn = oyster_gpkg, layer = "west_gavelston_bay_survey", append = F)
sf::st_write(oyster_restoration_sites, dsn = oyster_gpkg, layer = "oyster_restoration_sites", append = F)
sf::st_write(gom_atlas, dsn = oyster_gpkg, layer = "gom_atlas", append = F)
